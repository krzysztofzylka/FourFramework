		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body">
						<?php
						echo isset($config['adminPanel'])?'<a href="?page=framework_moduly_adminPanel&modul='.$name.'"><button type="button" class="btn btn-primary btn-sm">Przejdź do panelu</button></a>':'NIE';
						?>
					</div>
				</div>
			</div>
