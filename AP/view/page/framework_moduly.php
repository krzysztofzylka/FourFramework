				...
				<table class="table table-sm">
					...
					<tbody>
						...
						foreach($scandir as $fname){ //file loop
							...
							echo '<tr>
								<td>
								'.(isset($config['adminPanel'])?'<A href="?page=framework_moduly&type=adminpanel&modul='.$fname.'"><i class="fas fa-window-maximize" data-toggle="tooltip" data-placement="left" title="Panel administracyjny"></i></a>':'').'
								</td>
								<td><a href="index.php?page=framework_moduly&type=informacje&name='.$fname.'">'.$fname.'</a></td>
